...
import { cleanCreateProductError, createProduct, deleteProduct } from "../actions/productActions";
...
function CreateProduct(props) {
  ...
  const [description, setDescription] = useState(props.fields.description || "");
    ...
    <section className="sign-in">
      <div className="wrapper">
        <div className="sign-in__container">
          <h2 className="sign-in__title">{props.fields._id ? 'Update product card' : 'Create product card'}</h2>
          <form className="sign-in__form create-product__form" onSubmit={submitHandler}>
            {errorCreation && errorCreation.errors
              ...
              : errorCreation &&
                errorCreation.message && (
                  <div className="auth-warning-message">{errorCreation.message}</div>
                )}
            ...
            <select name="category" id="category" defaultValue={props.fields.category || 'DEFAULT'} className="sign-in__input" onChange={(e) => setCategory(e.target.value)}>
            ...
            <fieldset className="colors-field">
              ...
              <div className="color-checkbox-container">
                ...
                <input type="checkbox" name="color" id="color-blue" value="blue" onChange={handleColor} defaultChecked={checkColor('blue')}/>
              </div>
              <div className="color-checkbox-container">
                <label htmlFor="color-red">Red</label>
                <input type="checkbox" name="color" id="color-red" value="red" onChange={handleColor} defaultChecked={checkColor('red')}/>
              </div>
              <div className="color-checkbox-container">
                <label htmlFor="color-orange">Orange</label>
                <input type="checkbox" name="color" id="color-orange" value="orange" onChange={handleColor} defaultChecked={checkColor('orange')}/>
              </div>
              <div className="color-checkbox-container">
                <label htmlFor="color-green">Green</label>
                <input type="checkbox" name="color" id="color-green" value="green" onChange={handleColor} defaultChecked={checkColor('green')}/>
              </div>
              <div className="color-checkbox-container">
                <label htmlFor="color-black">Black</label>
                <input type="checkbox" name="color" id="color-black" value="black" onChange={handleColor} defaultChecked={checkColor('black')}/>
              </div>
            </fieldset>
            ...
            />
            <button type="submit" className="sign-in__submit-button button button_highlighted">
              {props.fields._id ? 'Update' : 'Create'}
            </button>
            <button type="button" className="button create-button-back" onClick={() => props.setVisibility(false)}>
              Back
            </button>
          </form>
        </div>
